...
@EnableJpaRepositories("ru.itis.dis.s2lab10.repositories")
...
public class Config implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        jpaProperties.setProperty("hibernate.hbm2ddl.auto", "none"); // none, update
        jpaProperties.setProperty("hibernate.show_sql", "true"); // ddl-auto
        em.setJpaProperties(jpaProperties);
        em.setPersistenceUnitName("lab10");
        em.setPackagesToScan("ru.itis.dis.s2lab10.model");
