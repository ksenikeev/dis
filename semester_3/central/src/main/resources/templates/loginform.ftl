...
<head>
    ...
    <link rel='stylesheet' href='/central/resources/css/lab10.css'>
    <script src='/central/resources/js/lab10.js'></script>
</head>
<body>
...
<div>
    <form action="/central/login" method="post" onsubmit="validate()">
